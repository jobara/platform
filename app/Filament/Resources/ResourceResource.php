...
class ResourceResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                SelectFilter::make('resource_type')->label(__('Resource types'))->relationship('resourceType', 'name')->getOptionLabelFromRecordUsing(fn (ResourceType $record) => $record->name),
